<?php
/**
 * Two-column layout for Post Block
 */

$wrapper_class = 'post-block-wrapper post-layout-2-column';
?>
<section class="<?php echo esc_attr($wrapper_class); ?>">
    <div class="posts-grid two-column">
        <?php while ($posts_query->have_posts()) : $posts_query->the_post(); ?>
            <article id="post-<?php the_ID(); ?>" class="blog-card layout-2-column">
