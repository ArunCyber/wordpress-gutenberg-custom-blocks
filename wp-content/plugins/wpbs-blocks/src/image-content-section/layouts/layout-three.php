 ...
 * Image section aligned on top. Title, contents and buttons below that.
 */
?>

<div class="image_content_wrapper image-content-section-layout-three alignfull" <?php echo $wrapper_attributes; ?>>
    <?php if ($image_url) : ?>
    ...
    <div class="content_wraper">
        ...
        <div class="ims-three-content-image-wrapper">
            <?php if ($content) : ?>
                ...
                <div class="image-content-section-button-wrapper">
                    ...
                    foreach ($buttons as $index => $button) {
                        ...
                        $hover_styles[] = sprintf(
                            'a.ims-three-href-%1$d:hover { background:%2$s; color:%3$s; }',
                            $index,
                            esc_attr($hover_bg),
                            esc_attr($hover_txt)
                        );
                    ...
                    ?>
                        <a
                            class="ims-three-href-<?php echo esc_attr($index); ?>"
