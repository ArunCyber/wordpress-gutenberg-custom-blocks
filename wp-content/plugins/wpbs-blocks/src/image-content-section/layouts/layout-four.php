 ...
 * Image section full width covered layout. Title, contents and buttons aligned center. 
 */
?>

<div class="image_content_wrapper image-content-section-layout-four alignfull" <?php echo $wrapper_attributes; ?> style="background-image: url('<?php echo esc_url($image_url); ?>');">
            ...
            <div class="image-content-section-button-wrapper">
                ...
                foreach ($buttons as $index => $button) {
                    ...
                    $hover_styles[] = sprintf(
                        'a.ims-four-href-%1$d:hover { background:%2$s; color:%3$s; }',
                        $index,
                        esc_attr($hover_bg),
                        esc_attr($hover_txt)
                    );
                ...
                ?>
                    <a
                        class="ims-four-href-<?php echo esc_attr($index); ?>"
